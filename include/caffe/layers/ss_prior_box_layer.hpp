#ifndef CAFFE_SSPRIORBOX_LAYER_HPP_
#define CAFFE_SSPRIORBOX_LAYER_HPP_
...
class SSPriorBoxLayer : public Layer<Dtype> {
 public:
  /**
   ...
   */
  explicit SSPriorBoxLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
...
#endif  // CAFFE_SSPRIORBOX_LAYER_HPP_
