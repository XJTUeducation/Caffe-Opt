#ifndef CAFFE_INSTANCE_INTERP_LAYER_HPP_
#define CAFFE_INSTANCE_INTERP_LAYER_HPP_
...
class InstanceInterpLayer : public Layer<Dtype> {
 public:
  explicit InstanceInterpLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "InstanceInterp"; }
...
#endif  // CAFFE_INSTANCE_INTERP_LAYER_HPP_
