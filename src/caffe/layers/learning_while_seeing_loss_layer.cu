...
__global__ void LearningWhileSeeingLossForwardGPU(const int nthreads,
...
template <typename Dtype>
__global__ void LearningWhileSeeingLossIgnoreDiffGPU(const int count,
...
template <typename Dtype>
void LearningWhileSeeingLossLayer<Dtype>::Forward_gpu(
...
//  LearningWhileSeeingLossForwardGPU<Dtype><<<CAFFE_GET_BLOCKS(count),
...
template <typename Dtype>
void LearningWhileSeeingLossLayer<Dtype>::Backward_gpu(
...
//      // NOLINT_NEXT_LINE(whitespace/operators)
//      LearningWhileSeeingLossIgnoreDiffGPU<Dtype><<<CAFFE_GET_BLOCKS(count),
...
INSTANTIATE_LAYER_GPU_FUNCS(LearningWhileSeeingLossLayer);
