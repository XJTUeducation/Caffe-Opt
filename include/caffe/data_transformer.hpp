...
public:
   ...
   */
    ...
    void TransformSeg(const Datum& datum,
   ...
   */
    ...
    void CropImageSeg(const Datum& datum,
                      const Datum& datum_seg,
    ...
    void CropImageSeg(const AnnotatedDatum& anno_datum,
                      const NormalizedBBox& bbox,
                      AnnotatedDatum* cropped_anno_datum) ;
   ...
   */
    ...
    void ExpandImageSeg(const Datum& datum,
                        const Datum& datum_seg,
    ...
    void ExpandImageSeg(const AnnotatedDatum& anno_datum,
                        AnnotatedDatum* expanded_anno_datum);
   ...
   */
    ...
    void TransformSeg(const cv::Mat& cv_img,
                      const cv::Mat& cv_seg,
                      Blob<Dtype>* transformed_blob,
                      Blob<Dtype>* transformed_blob_seg,
                      NormalizedBBox* crop_bbox,
   ...
   */
    ...
    void CropImageSeg(const cv::Mat& img,
                      const cv::Mat& seg,
                      const NormalizedBBox& bbox,
                      cv::Mat* crop_img,
                      cv::Mat* crop_seg);
   ...
   */
    ...
    void ExpandImageSeg(const cv::Mat& img,
                        const cv::Mat& seg,
                        const float expand_ratio,
                        NormalizedBBox* expand_bbox,
                        cv::Mat* expand_img,
    ...
    void TransformImgAndSegAll(const std::vector<cv::Mat>& cv_img_seg,
                            Blob<Dtype>* transformed_data_blob, Blob<Dtype>* transformed_label_blob,
                            const int ignore_label);

    void TransformImgAndSegOnline(
