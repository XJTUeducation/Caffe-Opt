...
namespace caffe {
/**
 * @brief Changes the spatial resolution by nearest neighbor interpolation.
...
class InterpNNLayer : public Layer<Dtype> {
 public:
  explicit InterpNNLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "InterpNN"; }
